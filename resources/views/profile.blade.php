            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('profilePut') }}">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address_street_1" type="text" class="form-control" name="address_street_1" value="{{ $user->address_street_1 }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address_street_2" type="text" class="form-control" name="address_street_2" value="{{ $user->address_street_2 }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address_state" type="text" class="form-control" name="address_state" value="{{ $user->address_state }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address_zip" type="text" class="form-control" name="address_zip" value="{{ $user->address_zip }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="mi_member_date" type="text" class="form-control" name="mi_member_date" value="{{ $user->mi_member_date }}" readonly>
                                </div>
                            </div>
